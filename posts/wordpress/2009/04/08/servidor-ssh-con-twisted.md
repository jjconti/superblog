<html><body><p>Actualicé <a href="http://www.devshed.com/c/a/Python/SSH-with-Twisted/" target="_blank">este ejemplo</a>, tamibién incluido en el <a href="http://books.google.com/books?id=Fm5kw3lZ7zEC&amp;printsec=frontcover&amp;hl=es&amp;source=gbs_summary_r&amp;cad=0" target="_blank">libro de Twisted</a> para que no tire Deprecation Warnings:



<!--more-->

</p><pre>from twisted.cred import portal, checkers, credentials
